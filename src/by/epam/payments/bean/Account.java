...
public class Account extends Entity implements Serializable {
	...
	public Account(int id, String numberIBAN, String currency, long balance, int clientId, 
	...
	public Account(String numberIBAN, String currency, long balance, int clientId, int bankDepartmentId) {
		this.numberIBAN = numberIBAN;
		this.currency = currency;
		this.balance = balance;
		this.clientId = clientId;
